...
const ParentLayout = () => {
  ...
  const menuItems = [
    { name: 'Trang chủ', path: '/parent/home', icon: '🏠' },
    { name: 'Lịch sử', path: '/parent/history', icon: '📋' },
    { name: 'Thông báo', path: '/parent/notifications', icon: '📢' },
    { name: 'Hồ sơ', path: '/parent/profile', icon: '👤' }
  ];
          ...
          <div className="flex items-center justify-between h-16 px-4">
            ...
            <div className="flex items-center space-x-4">
              <h2 className="text-lg font-semibold text-gray-800">
                {menuItems.find(item => isActiveRoute(item.path))?.name || 'Trang chủ'}
              </h2>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600">Con đang an toàn</span>
              </div>
